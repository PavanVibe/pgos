...
exports.MonthlyInvoiceService = void 0;
...
class MonthlyInvoiceService {
     ...
     */
    static async generateMonthlyInvoices(actorId = 'system') {
        ...
        const activeProfiles = await prisma_1.default.pGTenantProfile.findMany({
            where: {
        ...
        for (const profile of activeProfiles) {
            ...
            const existingInvoice = await prisma_1.default.rentInvoice.findFirst({
                where: {
...
exports.MonthlyInvoiceService = MonthlyInvoiceService;
//# sourceMappingURL=MonthlyInvoiceService.js.map